...
Database Engineer with experience in **RDBMS(<span style="color:#e74c3c">Tibero</span>) core engineering, SQL optimization, and query optimizer development** at an enterprise database vendor.

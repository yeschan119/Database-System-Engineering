...
Database Engineer with experience in **RDBMS core engineering**(!(https://img.shields.io/badge/Tibero-Tibero-red)), SQL optimization, and query optimizer development** at an enterprise database vendor.
